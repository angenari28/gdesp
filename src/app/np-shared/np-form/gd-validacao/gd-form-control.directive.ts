...
export class GdFormControl {
  ...
  //decorateLabel() {
  //    this.labelElement = this.getLabel();
  //    if (this.labelElement.querySelector("strong") &&
  //        this.labelElement.querySelector("strong").innerText == " *") {
  //        return;
  //    }
  //    let span = this.renderer.createElement(this.labelElement, "span");
  //    this.renderer.setElementClass(span, "text-danger", true);
  //    let strong = this.renderer.createElement(span, "strong");
  //    strong.innerText = " *";

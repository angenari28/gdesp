...
export class GdLoaderService {
  ...
  private static instance: GdLoaderService;
  ...
  constructor() {
    if (GdLoaderService.instance) {
      return GdLoaderService.instance;
    }
    this.urlsRegistradas = [];
    this.loaderStatus = [];
    this.defaultLoader = TipoLoaderEnum.FULL;
    GdLoaderService.instance = this;
  }

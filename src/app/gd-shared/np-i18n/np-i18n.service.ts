...
export class NpI18nService {
  ...
  constructor(public jsonApiService: NpJSONService, public ref: ApplicationRef, public router: Router) {
  ...
  public fetch(locale: any) {
    this.baseRoute = `/np-i18n/${locale}/resources/base.json`;
    this.menuRoute = `/np-i18n/${locale}/resources/menu.json`;
  ...
  public loadConfig(locale: string): Observable<any> {
    return this.jsonApiService.fetch(`/np-i18n/${locale}/${locale}.config.json`);
  }
  ...
  public fetchByRoute(locale: any, routeUrl: string) {
    ...
    this.route = `/np-i18n/${locale}/resources/${routeUrl}.json`;

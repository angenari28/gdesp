...
import { addDespesa, getAllDespesa, deleteDespesa, getAllByDespesa } from './../../../database/src/domain/channel/despesa.channel';
...
export class DespesasService {
  ...
  getDespesasBy(ano: any): Observable<DespesaEntity[]> {
    return of(this.electronService.ipcRenderer.sendSync(getAllByDespesa, ano)).pipe(
      catchError((error: any) => throwError(error.json))
    );
  }
